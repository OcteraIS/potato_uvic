    ...
    for label in labels:
        ...
        if "textarea" in annotation_scheme and annotation_scheme["textarea"]["on"]:
            ...
            schematic += (
                ...
                + '<textarea rows="%s" cols="%s" class="%s" style=%s type="text" id="%s" name="%s" validation="%s"></textarea> '
            ) % (
                name,
                tooltip,
            ...
            schematic += (
                '  <label for="%s" %s>%s</label> <input class="%s" style=%s type="text" id="%s" name="%s" validation="%s">  '
            ) % (
                name,
                tooltip,
                label if label != "text_box" else "",
